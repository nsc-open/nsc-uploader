...
var Crypto2__default = /*#__PURE__*/_interopDefaultLegacy(Crypto2);
...
var encodeFileName = function encodeFileName(filename) {
  ...
  var hash = Crypto2.createHash('md5').update(filename + timeStr).digest('hex');
  return hash;
};
...
var UploadList = /*#__PURE__*/function (_React$Component) {
  ...
  function UploadList() {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderListItem", function (file) {
      ...
      var removeIcon = showRemoveIcon && items.every(function (i) {
...
var Crypto = require('crypto-browserify'); // A through stream that calculates md5sum and sha256sum


function getHashSummer(enableSHA256) {
  var md5 = Crypto2__default['default'].createHash('md5');
  var sha256 = Crypto2__default['default'].createHash('sha256');
  return Through2__default['default'].obj(function (chunk, enc, cb) {
    if (enableSHA256) {
      sha256.update(chunk);
    } else {
      md5.update(chunk);
...
function readableStream(data) {
  var s = new stream__default['default'].Readable();
...
function insertContentType(metaData, file) {
...
var putObject = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(client, bucketName, objectName, file, options, metaData, callback) {
    var maxObjectSize, partSize, uploader, hash, fileContent, buffer, stream, doneParts, internalDoneParts, uploadedSize, partOffs, numParts, all, multipartFinish, done, todo, defaultParallel, getUploadId, uploadId, uploadPartJob, jobErr, abortEvent;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            throw new Error("Invalid object name: ".concat(objectName));
          ...
          case 8:
            ...
            return _context2.abrupt("return", callback(new Error(" size : ".concat(file.size, ", max allowed size : 5TB"))));

          case 11:
            // Ensures Metadata has appropriate prefix for A3 API
            metaData = insertContentType(metaData, file); // Updates metaData to have the correct prefix if needed
          ...
          case 24:
            ...
            if (doneParts.length > 0) {
              internalDoneParts = [].concat(_toConsumableArray(internalDoneParts), doneParts);
            }

            partOffs = divideParts(file.size, partSize);
            ...
            defaultParallel = 5; // upload in parallel

            getUploadId = function getUploadId(bucketName, objectName, metaData) {
              return new Promise(function (resolve, reject) {
                client.findUploadId(bucketName, objectName, function (err, uploadId) {
                  if (err) throw new Error(err);

                  if (uploadId) {
                    resolve(uploadId);
                  } else {
                    client.initiateNewMultipartUpload(bucketName, objectName, metaData, function (e, uploadId) {
          ...
          case 38:
                          ...
                          pipesetup(stream, dst).on('data', function (data) {
                            ...
                            if (!multipartFinish) {
                              ...
                              uploader(uploadId, partNo, stream, partSize, data.sha256sum, data.md5sum, function (e, objInfo) {
                                ...
                                if (options.progress) {
                                  options.progress(doneParts.length / numParts, {
                                    file: file,
                                    name: objectName,
                                    fileSize: file.size,
                                    uploadId: uploadId,
            ...
            return parallel(todo, defaultParallel, function (value) {
              return new Promise(function (resolve, reject) {
                uploadPartJob(file, value, uploadId).then(function (r) {
                  var partNo = r.partNo,
                      objInfo = r.objInfo,
                      length = r.length;
                  uploadedSize += length;
...
var parallel = function parallel(todo, _parallel, jobPromise) {
  return new Promise(function (resolve) {
    var _jobErr = [];
  ...
  _createClass(SingletonOss, [{
    ...
    value: function _getOss() {
      ...
      var Instance = this._ossList.filter(function (res) {
        return _this2._params.source === res.key;
      })[0].ossInstance;
...
var MinIO = /*#__PURE__*/function (_InterfaceOss) {
  ...
  function MinIO(args) {
    ...
    _defineProperty(_assertThisInitialized(_this), "signatureUrl", function (file) {
      return new Promise(function (resolve, reject) {
        _this.client.presignedUrl('GET', _this.params.bucket, file.name, _this.exepTime, function (err, presignedUrl) {
          if (err) return reject(err);
    ...
    _defineProperty(_assertThisInitialized(_this), "upload", function (encodedFileName, file, options) {
      return new Promise(function (resolve, rej) {
        _this.client.putObject(_this.client, _this.params.bucket, encodedFileName, file, options, {
          ...
          _this.client.presignedUrl('GET', _this.params.bucket, encodedFileName, _this.exepTime, function (err, presignedUrl) {
    ...
    _defineProperty(_assertThisInitialized(_this), "getUploadedUrl", function (uploadRes, uploadType, file) {
      return uploadRes;
    });

    _defineProperty(_assertThisInitialized(_this), "getUploadProgress", function () {// To be developed
    });
  ...
  _createClass(MinIO, [{
    key: "multipartUpload",
    value: function () {
      var _multipartUpload = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, file, options) {
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", this.upload(name, file, options));
...
var Uploader = /*#__PURE__*/function (_Component) {
  ...
  function Uploader(props) {
    ...
    _defineProperty(_assertThisInitialized(_this2), "onBatchDelete", function () {
      ...
      if (selectedIds.length > 0) {
        ...
        _this2.handleChange && _this2.handleChange({}, newFileList);
    ...
    _defineProperty(_assertThisInitialized(_this2), "getFiles", function () {
      return _this2.state.fileList;
    });

    _defineProperty(_assertThisInitialized(_this2), "signatureUrl", function (url) {
      return _this2.uploadClient.signatureUrl(url);
    });
    ...
    _defineProperty(_assertThisInitialized(_this2), "onChecked", function (e, file) {
  ...
  _createClass(Uploader, [{
    ...
    value: function componentDidUpdate(prevprops) {
      if (!isEqual_1(prevprops.defaultFiles, this.props.defaultFiles)) {
        this.setState({
    ...
    value: function () {
      var _createOssInstance = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(ossParams) {
        var params;
      ...
      function createOssInstance(_x9) {
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          ...
          restProps = _objectWithoutProperties(_this$props2, ["dragSortable", "beforeUpload", "type", "maxFileNum", "disabled", "children", "className", "showUploadButton", "customRadioButton", "displayTools", "showBatchButton"]);
